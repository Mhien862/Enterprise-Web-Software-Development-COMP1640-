...
const token =
  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2NWY1NzVjN2UzNTM2MzM5NmFhYjQxYTMiLCJpYXQiOjE3MTA3MjU4MjUsImV4cCI6MTcxMzMxNzgyNX0.N34sr5pBM6101qGfhVf0OREHspTO4RKROSRuCgZNMsQ	";
...
export const createNewUser = createAsyncThunk(
  "https://enterprise-web-software-development.onrender.com/register",
  async (data) => {
    try {
...
const loginAPI = async (email, password) => {
  const res = await axiosInstance.post(
    "https://enterprise-web-software-development.onrender.com/login ",
    { email, password }
  );
